 // Wait for PhoneGap to load
        ...
        function win(r) {
			...
			var imageThumb = '<li><img src="'+EVENT_UPLOAD_PATH+PicName+'" alt="'+PicName+'"/></li>'
			$('.uploadedImages ul').html(imageThumb);
			//var oldPics = window.localStorage.getItem("GamesPics");
			//PicName = PicName+","+oldPics;
			window.localStorage.setItem("event_picture",PicName);
            console.log(window.localStorage.getItem("event_picture"));
            //console.log(r);
			//getUserInfo();
        }
