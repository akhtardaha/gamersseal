...
jQuery(document).ready(function(){
	jQuery('#appbgclr').ColorPicker({
		...
		jQuery('#appbgclr').css('backgroundColor', '#' + hex);
		}
	})
	.bind('keyup', function(){
		jQuery(this).ColorPickerSetColor(this.value);
	...
	jQuery('#message_history').DataTable();
});
...
jQuery(document).ready(function(){
    ...
    var file_data = jQuery('#appicon').prop('files')[0];   
    ...
    jQuery.ajax({
                ...
                type: 'post',
                success: function(data){
					jQuery('.previewIcon img').prop('src',siteUrl+'/'+data);
                    console.log(data);
